...
const render = () => {
  ...
  uniforms.battery.value = battery;
  uniforms.hours.value = getRatioFromCurrentTime(CLOCK_TYPE.HOURS, uniforms.battery.value);
  uniforms.minutes.value = getRatioFromCurrentTime(CLOCK_TYPE.MINUTES, uniforms.battery.value);
  uniforms.seconds.value = getRatioFromCurrentTime(CLOCK_TYPE.SECONDS, uniforms.battery.value);
  uniforms.milliseconds.value = easing.easeOutExpo(
    getRatioFromCurrentTime(CLOCK_TYPE.MILLISECONDS, uniforms.battery.value)
  );
